...
function Overview() {
    return (
        <div className="mt-6">
            <h1 className="text-2xl text-[#485162]">Tổng quan</h1>
            <div className="mt-4 flex justify-between gap-6">
                <div className="flex flex-auto rounded-md bg-[#FFFFFF] px-4 py-4 shadow-xl">
            ...
            <ul className="mt-4 grid grid-cols-3 gap-5">
                <li className="flex rounded-xl bg-[#FFFFFF] px-4 py-2 shadow-xl">
                    <div className="flex-auto">
